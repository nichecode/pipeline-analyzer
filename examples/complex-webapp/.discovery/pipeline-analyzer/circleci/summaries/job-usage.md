...
| 4 | hold-for-approval | 1 | [hold-for-approval](../jobs/hold-for-approval.md) |
| 5 | test-frontend | 1 | [test-frontend](../jobs/test-frontend.md) |
| 6 | build-backend | 1 | [build-backend](../jobs/build-backend.md) |
| 7 | lint-backend | 1 | [lint-backend](../jobs/lint-backend.md) |
| 8 | deploy-production | 1 | [deploy-production](../jobs/deploy-production.md) |
| 9 | lint-frontend | 1 | [lint-frontend](../jobs/lint-frontend.md) |
| 10 | test-backend | 1 | [test-backend](../jobs/test-backend.md) |
| 11 | test-integration | 1 | [test-integration](../jobs/test-integration.md) |
| 12 | build-frontend | 1 | [build-frontend](../jobs/build-frontend.md) |
| 13 | build-docker-images | 1 | [build-docker-images](../jobs/build-docker-images.md) |
| 14 | deploy-staging | 1 | [deploy-staging](../jobs/deploy-staging.md) |
